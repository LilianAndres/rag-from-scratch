...
class BackendFactory:
    ...
    def create_backend(self, embedder: BaseEmbedder) -> SearchBackend:
        match self._config.type:
            ...
            case "chroma":
                from app.src.backends.chroma_backend import ChromaBackend
            ...
            case "elk":
                from app.src.backends.elk_backend import ELKBackend
            ...
            case "hybrid":
                from app.src.backends.hybrid_backend import HybridBackend
